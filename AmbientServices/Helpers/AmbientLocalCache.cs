...
public class AmbientLocalCache
{
    ...
    /// </summary>
    /// <param name="ownerType">The <see cref="Type"/> of the owner.</param>
    ...
    public AmbientLocalCache(Type ownerType, string? cacheKeyPrefix = null)
    ...
    /// <param name="cacheKeyPrefix">An optional cache key prefix for all items cached through this class.  Uses the type name if not specified.</param>
    public AmbientLocalCache(Type ownerType, IAmbientLocalCache? cache, string? cacheKeyPrefix = null)
    {
        if (ownerType == null) throw new ArgumentNullException(nameof(ownerType));
        _cacheKeyPrefix = ownerType.Name + "-";
...
public class AmbientLocalCache<TOWNER> : AmbientLocalCache
{
    ...
    public AmbientLocalCache(IAmbientLocalCache? cache, string? cacheKeyPrefix = null)
        : base (typeof(TOWNER), cache, cacheKeyPrefix)
    {
    }
}
