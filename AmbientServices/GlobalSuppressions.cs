...
[assembly: SuppressMessage("Design", "CA1031:Do not catch general exception types", Justification = "This is terrible advice, especially for systems that need to run persistently", Scope = "member", Target = "~M:AmbientServices.TraceBuffer.TraceBufferBackgroundFlusher")]
...
[assembly: SuppressMessage("Design", "CA1031:Do not catch general exception types", Justification = "This is terrible advice, especially for systems that need to run persistently", Scope = "member", Target = "~M:AmbientServices.ConsoleBuffer.ConsoleBufferBackgroundFlusher")]
...
[assembly: SuppressMessage("Usage", "CA2213:Disposable fields should be disposed", Justification = "The field is disposed, but through the reference Interlocked.Exchange swaps out of it, so that a notification racing disposal sees null rather than a disposed thread-local; the analyzer cannot follow the swap", Scope = "member", Target = "~F:AmbientServices.ThreadSurveyManager._threadDistributors")]
