...
public class TestLocalCache
{
    ...
    public async Task LocalCacheAmbient()
    {
        ...
        {
            _ = new AmbientLocalCache(typeof(TestLocalCache), nameof(LocalCacheAmbient) + "-non-generic");
    ...
    public async Task LocalCacheDisposable()
    {
        ...
        using (new ScopedLocalServiceOverride<IAmbientSettingsSet>(localSettingsSet))
        {
            ...
            AmbientLocalCache<TestLocalCache> cache = new();
            using DisposableCacheEntry dce1 = new(1);
            using DisposableCacheEntry dce2 = new(2);
            using DisposableCacheEntry dce3 = new(3);
            using DisposableCacheEntry dce4 = new(4);
            using DisposableCacheEntry dce5 = new(5);
            using DisposableCacheEntry dce6 = new(6);
            using DisposableCacheEntry dce7 = new(7);
            using DisposableCacheEntry dce8 = new(8);
