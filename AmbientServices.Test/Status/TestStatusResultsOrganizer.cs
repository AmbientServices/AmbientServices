    ...
    public class TestStatusResultsOrganizer
    {
        ...
        public void StatusPropertyRange()
        {
            using (AmbientClock.Pause())
            {
                ...
                StatusPropertyRange range = new StatusPropertyRange(StatusProperty.Create("property", 5));
        ...
        public void StatusResultsOrganizer()
        {
            using (AmbientClock.Pause())
            {
                ...
                organizer.Add(organizer, new StatusResults(null, "/SampleDisk.SystemTemp", AmbientClock.UtcNow, 0, new StatusProperty[] { StatusProperty.Create("AvailablePercent", "1.0") }, null), "Source1");
                organizer.Add(organizer, new StatusResults(null, "/SampleDisk.SystemTemp", AmbientClock.UtcNow, 0, new StatusProperty[] { StatusProperty.Create("AvailablePercent", "1.5") }, null), "Source1");
                organizer.Add(organizer, new StatusResults("Source2", "/SampleDisk.SystemTemp", AmbientClock.UtcNow, 0, new StatusProperty[] { StatusProperty.Create("AvailablePercent", "2.3") }, null), "Source1");
                organizer.Add(organizer, new StatusResults(null, "/SampleDisk.Temp", AmbientClock.UtcNow, 0, new StatusProperty[] { StatusProperty.Create("AvailablePercent", "4.0") }, null), "Source1");
                organizer.Add(organizer, new StatusResults(null, "/SampleDisk.OperatingSystem", AmbientClock.UtcNow, 0, new StatusProperty[] { StatusProperty.Create("AvailablePercent", "10.0") }, new StatusAuditReport(AmbientClock.UtcNow, TimeSpan.FromMilliseconds(10), DateTime.UtcNow.AddMinutes(1))), "Source2");
                ...
                StatusResults source1Root = new StatusResults(null, null, AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogenous, new StatusResults[] {
                    new StatusResults(null, "/SampleDisk.OperatingSystem", AmbientClock.UtcNow, 0, new StatusProperty[] { StatusProperty.Create("AvailablePercent", "1.0") }, StatusNatureOfSystem.ChildrenHeterogenous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow, 0, new StatusProperty[] { StatusProperty.Create("Att1", "Val1.0"), StatusProperty.Create("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                    new StatusResults(null, "/Target2", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogenous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow, 0, new StatusProperty[] { StatusProperty.Create("Att1", "Val1.0"), StatusProperty.Create("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                });
                StatusResults source2Root = new StatusResults(null, null, AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogenous, new StatusResults[] {
                    new StatusResults(null, "/SampleDisk.OperatingSystem", AmbientClock.UtcNow, 0, new StatusProperty[] { StatusProperty.Create("AvailablePercent", "2.3") }, StatusNatureOfSystem.ChildrenHeterogenous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow, 0, new StatusProperty[] { StatusProperty.Create("Att1", "Val1.1"), StatusProperty.Create("Att2", "Val2.1") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                    new StatusResults(null, "/Target2", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogenous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow, 0, new StatusProperty[] { StatusProperty.Create("Att1", "Val1.1"), StatusProperty.Create("Att2", "Val2.1") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                });
        ...
        public void StatusResultsOrganizerTime()
        {
            using (AmbientClock.Pause())
            {
                ...
                organizer = new StatusResultsOrganizer();
                StatusResults source1Root = new StatusResults(null, null, AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogenous, new StatusResults[] {
                    new StatusResults(null, "/Target1", AmbientClock.UtcNow.AddSeconds(2), 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogenous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow.AddSeconds(2), 0, new StatusProperty[] { StatusProperty.Create("Att1", "Val1.0"), StatusProperty.Create("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                    new StatusResults(null, "/Target2", AmbientClock.UtcNow.AddSeconds(3), 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogenous, new StatusResults[] { new StatusResults(null, "Part2", AmbientClock.UtcNow.AddSeconds(3), 0, new StatusProperty[] { StatusProperty.Create("Att1", "Val1.0"), StatusProperty.Create("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                    new StatusResults(null, "/Target3", AmbientClock.UtcNow.AddSeconds(1), 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogenous, new StatusResults[] { new StatusResults(null, "Part3", AmbientClock.UtcNow.AddSeconds(1), 0, new StatusProperty[] { StatusProperty.Create("Att1", "Val1.0"), StatusProperty.Create("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                });
                ...
                StatusResults source3Root = new StatusResults(null, null, AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogenous, new StatusResults[] {
                    new StatusResults(null, "/Target1", AmbientClock.UtcNow.AddSeconds(1), 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogenous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow.AddSeconds(1), 0, new StatusProperty[] { StatusProperty.Create("Att1", "Val1.0"), StatusProperty.Create("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                    new StatusResults(null, "/Target2", AmbientClock.UtcNow.AddSeconds(3), 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogenous, new StatusResults[] { new StatusResults(null, "Part2", AmbientClock.UtcNow.AddSeconds(3), 0, new StatusProperty[] { StatusProperty.Create("Att1", "Val1.0"), StatusProperty.Create("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                    new StatusResults(null, "/Target3", AmbientClock.UtcNow.AddSeconds(2), 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogenous, new StatusResults[] { new StatusResults(null, "Part3", AmbientClock.UtcNow.AddSeconds(2), 0, new StatusProperty[] { StatusProperty.Create("Att1", "Val1.0"), StatusProperty.Create("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                });
        ...
        public void StatusResultsOrganizerPropertiesWorse()
        {
            using (AmbientClock.Pause())
            {
                ...
                organizer = new StatusResultsOrganizer();
                StatusResults source1Root = new StatusResults(null, null, AmbientClock.UtcNow, 0, new StatusProperty[] { StatusProperty.Create("AvailablePercent", "1.0") }, StatusNatureOfSystem.ChildrenHeterogenous, new StatusResults[] {
                    new StatusResults(null, "/SampleDisk.OperatingSystem", AmbientClock.UtcNow, 0, new StatusProperty[] { StatusProperty.Create("AvailablePercent", "2.0"), StatusProperty.Create("AvailablePercent", "2.1") }, StatusNatureOfSystem.ChildrenHeterogenous, new StatusResults[] {
                        new StatusResults(null, "/SampleDisk.Temp", AmbientClock.UtcNow, 0, new StatusProperty[] { StatusProperty.Create("AvailablePercent", "2.2") , StatusProperty.Create("AvailableBytes", "1100000000.0") }, new StatusAuditReport(AmbientClock.UtcNow, TimeSpan.FromSeconds(3), AmbientClock.UtcNow.AddSeconds(2), new StatusAuditAlert(StatusRating.Okay - .0001f, "ALERT", "Alert", "AlertDetails"))),
                        new StatusResults(null, "Part1", AmbientClock.UtcNow, 0, new StatusProperty[] { StatusProperty.Create("Att1", "Val1.0"), StatusProperty.Create("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()),
                    }),
                    new StatusResults(null, "/Target2", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogenous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow, 0, new StatusProperty[] { StatusProperty.Create("Att1", "Val1.0"), StatusProperty.Create("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                });
                StatusResults source2Root = new StatusResults(null, null, AmbientClock.UtcNow.AddSeconds(1), 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogenous, new StatusResults[] {
                    new StatusResults(null, "/SampleDisk.OperatingSystem", AmbientClock.UtcNow.AddSeconds(1), 0, new StatusProperty[] { StatusProperty.Create("AvailablePercent", "2.3") }, StatusNatureOfSystem.ChildrenHeterogenous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow, 0, new StatusProperty[] { StatusProperty.Create("Att1", "Val1.1"), StatusProperty.Create("Att2", "Val2.1") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                    new StatusResults(null, "/Target2", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogenous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow, 0, new StatusProperty[] { StatusProperty.Create("Att1", "Val1.1"), StatusProperty.Create("Att2", "Val2.1") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                });
                StatusResults overallRoot = new StatusResults(null, "/", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogenous, new StatusResults[] {
                    source1Root,
