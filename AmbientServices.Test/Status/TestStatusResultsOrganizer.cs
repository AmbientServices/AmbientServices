...
public class TestStatusResultsOrganizer
{
    ...
    public void StatusResultsOrganizer()
    {
        using (AmbientClock.Pause())
        {
            ...
            organizer.Add(organizer, new StatusResults("Source1", "Target2", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogeneous, Array.Empty<StatusResults>()));
            organizer.Add(organizer, new StatusResults("Source2", "Target2", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogeneous, Array.Empty<StatusResults>()));
            ...
            organizer.Add(organizer.Children.First(), new StatusResults(null, null, AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogeneous, Array.Empty<StatusResults>()));
            organizer.Add(organizer.Children.First(), new StatusResults(null, "/", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogeneous, Array.Empty<StatusResults>()));
            organizer.Add(organizer.Children.Skip(1).First(), new StatusResults(null, "/", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogeneous, Array.Empty<StatusResults>()));
            organizer.Add(organizer.Children.Skip(2).First(), new StatusResults(null, "/", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogeneous, Array.Empty<StatusResults>()));
            ...
            organizer = new StatusResultsOrganizer();
            StatusResults source1Root = new(null, null, AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogeneous, new StatusResults[] {
                new StatusResults(null, "/SampleDisk.OperatingSystem", AmbientClock.UtcNow, 0, new StatusProperty[] { new StatusProperty("AvailablePercent", "1.0") }, StatusNatureOfSystem.ChildrenHeterogeneous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow, 0, new StatusProperty[] { new StatusProperty("Att1", "Val1.0"), new StatusProperty("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                new StatusResults(null, "/Target2", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogeneous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow, 0, new StatusProperty[] { new StatusProperty("Att1", "Val1.0"), new StatusProperty("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
            });
            StatusResults source2Root = new(null, null, AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogeneous, new StatusResults[] {
                new StatusResults(null, "/SampleDisk.OperatingSystem", AmbientClock.UtcNow, 0, new StatusProperty[] { new StatusProperty("AvailablePercent", "2.3") }, StatusNatureOfSystem.ChildrenHeterogeneous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow, 0, new StatusProperty[] { new StatusProperty("Att1", "Val1.1"), new StatusProperty("Att2", "Val2.1") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                new StatusResults(null, "/Target2", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogeneous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow, 0, new StatusProperty[] { new StatusProperty("Att1", "Val1.1"), new StatusProperty("Att2", "Val2.1") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
            });
            StatusResults overallRoot = new(null, "/", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogeneous, new StatusResults[] {
                source1Root,
                source2Root,
            });
    ...
    public void StatusResultsOrganizerTime()
    {
        using (AmbientClock.Pause())
        {
            ...
            organizer = new StatusResultsOrganizer();
            StatusResults source1Root = new(null, null, AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogeneous, new StatusResults[] {
                new StatusResults(null, "/Target1", AmbientClock.UtcNow.AddSeconds(2), 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogeneous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow.AddSeconds(2), 0, new StatusProperty[] { new StatusProperty("Att1", "Val1.0"), new StatusProperty("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                new StatusResults(null, "/Target2", AmbientClock.UtcNow.AddSeconds(3), 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogeneous, new StatusResults[] { new StatusResults(null, "Part2", AmbientClock.UtcNow.AddSeconds(3), 0, new StatusProperty[] { new StatusProperty("Att1", "Val1.0"), new StatusProperty("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                new StatusResults(null, "/Target3", AmbientClock.UtcNow.AddSeconds(1), 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogeneous, new StatusResults[] { new StatusResults(null, "Part3", AmbientClock.UtcNow.AddSeconds(1), 0, new StatusProperty[] { new StatusProperty("Att1", "Val1.0"), new StatusProperty("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
            });
            AmbientClock.SkipAhead(TimeSpan.FromSeconds(10));
            StatusResults source2Root = new(null, null, AmbientClock.UtcNow.AddSeconds(5), 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogeneous, new StatusResults[] {
                new StatusResults(null, "/Target1", AmbientClock.UtcNow.AddSeconds(2), 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogeneous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow.AddSeconds(2), 0, new StatusProperty[] { new StatusProperty("Att1", "Val1.0"), new StatusProperty("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                new StatusResults(null, "/Target2", AmbientClock.UtcNow.AddSeconds(3), 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogeneous, new StatusResults[] { new StatusResults(null, "Part2", AmbientClock.UtcNow.AddSeconds(3), 0, new StatusProperty[] { new StatusProperty("Att1", "Val1.0"), new StatusProperty("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                new StatusResults(null, "/Target3", AmbientClock.UtcNow.AddSeconds(1), 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogeneous, new StatusResults[] { new StatusResults(null, "Part3", AmbientClock.UtcNow.AddSeconds(1), 0, new StatusProperty[] { new StatusProperty("Att1", "Val1.0"), new StatusProperty("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
            });
            AmbientClock.SkipAhead(TimeSpan.FromSeconds(10));
            StatusResults source3Root = new(null, null, AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogeneous, new StatusResults[] {
                new StatusResults(null, "/Target1", AmbientClock.UtcNow.AddSeconds(1), 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogeneous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow.AddSeconds(1), 0, new StatusProperty[] { new StatusProperty("Att1", "Val1.0"), new StatusProperty("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                new StatusResults(null, "/Target2", AmbientClock.UtcNow.AddSeconds(3), 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogeneous, new StatusResults[] { new StatusResults(null, "Part2", AmbientClock.UtcNow.AddSeconds(3), 0, new StatusProperty[] { new StatusProperty("Att1", "Val1.0"), new StatusProperty("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                new StatusResults(null, "/Target3", AmbientClock.UtcNow.AddSeconds(2), 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogeneous, new StatusResults[] { new StatusResults(null, "Part3", AmbientClock.UtcNow.AddSeconds(2), 0, new StatusProperty[] { new StatusProperty("Att1", "Val1.0"), new StatusProperty("Att2", "Val2.0") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
            });
    ...
    public void StatusResultsOrganizerPending()
    {
        using (AmbientClock.Pause())
        {
            ...
            organizer = new StatusResultsOrganizer();
            StatusResults source1Root = new(null, null, AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogeneous, new StatusResults[] {
                new StatusResults(null, "/Pending", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogeneous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusAuditReport.Pending) }),
                new StatusResults(null, "/Pending", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogeneous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusAuditReport.Pending) }),
            });
            StatusResults source2Root = new(null, null, AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogeneous, new StatusResults[] {
    ...
    public void StatusResultsOrganizerPropertiesWorse()
    {
        using (AmbientClock.Pause())
        {
            ...
            organizer = new StatusResultsOrganizer();
            StatusResults source1Root = new(null, null, AmbientClock.UtcNow, 0, new StatusProperty[] { new StatusProperty("AvailablePercent", "1.0") }, StatusNatureOfSystem.ChildrenHeterogeneous, new StatusResults[] {
                new StatusResults(null, "/SampleDisk.OperatingSystem", AmbientClock.UtcNow, 0, new StatusProperty[] { new StatusProperty("AvailablePercent", "2.0"), new StatusProperty("AvailablePercent", "2.1") }, StatusNatureOfSystem.ChildrenHeterogeneous, new StatusResults[] {
            ...
            StatusResults source2Root = new(null, null, AmbientClock.UtcNow.AddSeconds(1), 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogeneous, new StatusResults[] {
                new StatusResults(null, "/SampleDisk.OperatingSystem", AmbientClock.UtcNow.AddSeconds(1), 0, new StatusProperty[] { new StatusProperty("AvailablePercent", "2.3") }, StatusNatureOfSystem.ChildrenHeterogeneous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow, 0, new StatusProperty[] { new StatusProperty("Att1", "Val1.1"), new StatusProperty("Att2", "Val2.1") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
                new StatusResults(null, "/Target2", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHeterogeneous, new StatusResults[] { new StatusResults(null, "Part1", AmbientClock.UtcNow, 0, new StatusProperty[] { new StatusProperty("Att1", "Val1.1"), new StatusProperty("Att2", "Val2.1") }, StatusNatureOfSystem.Leaf, Array.Empty<StatusResults>()) }),
            });
            StatusResults overallRoot = new(null, "/", AmbientClock.UtcNow, 0, Array.Empty<StatusProperty>(), StatusNatureOfSystem.ChildrenHomogeneous, new StatusResults[] {
                source1Root,
