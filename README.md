...
public static class AssemblyLoggingExtensions
{
    ...
    {
        Logger.Filter("Lifetime", AmbientLogLevel.Trace)?.LogMessage("AssemblyLoaded: " + assembly.FullName);
    }
    /// <summary>
    ...
    {
        Logger.Filter("Scan", AmbientLogLevel.Trace)?.LogMessage("Assembly " + assembly.FullName + " scanned");
    }
}
/// <summary>
...
public static class MyProgram
{
    ...
    public static void Process()
    {
        ...
        using (new ScopedLocalServiceOverride<IAmbientLogger>(bl))
        {
            try
            {
                Logger.Filter("Process", AmbientLogLevel.Debug)?.LogMessage("Starting processing...");
            }
            catch (Exception ex)
            {
...
public class RequestType
{
    ...
    public RequestType(string typeName)
    {
        ...
        _pendingRequests = ambientStatistics?.GetOrAddStatistic(false, typeName + "-RequestsPending", "Pending Requests", "The number of requests currently executing", false, "", 0, null, null, 0, AggregationTypes.Average | AggregationTypes.Max | AggregationTypes.MostRecent, AggregationTypes.Average | AggregationTypes.Sum | AggregationTypes.Max | AggregationTypes.MostRecent, AggregationTypes.Sum, AggregationTypes.Sum, MissingSampleHandling.LinearEstimation);
        _totalRequests = ambientStatistics?.GetOrAddStatistic(false, typeName + "-TotalRequests", "Total Requests", "The total number of requests that have finished executing", false, "", 0, null, null, 0, AggregationTypes.Average | AggregationTypes.Max | AggregationTypes.MostRecent, AggregationTypes.Average | AggregationTypes.Sum | AggregationTypes.Max | AggregationTypes.MostRecent, AggregationTypes.Sum, AggregationTypes.Sum, MissingSampleHandling.LinearEstimation);
        _totalProcessingTime = ambientStatistics?.GetOrAddStatistic(true, typeName + "-TotalProcessingTime", "Total Processing Time", "The total time spent processing requests (only includes completed requests)", false, "seconds", 0, null, null, 0, AggregationTypes.Average | AggregationTypes.Max | AggregationTypes.MostRecent, AggregationTypes.Average | AggregationTypes.Sum | AggregationTypes.Max | AggregationTypes.MostRecent, AggregationTypes.Sum, AggregationTypes.Sum, MissingSampleHandling.LinearEstimation);
        _retries = ambientStatistics?.GetOrAddStatistic(false, typeName + "-Retries", "Retries", "The total number of retries", false, "", 0, null, null, 0, AggregationTypes.Average | AggregationTypes.Max | AggregationTypes.MostRecent, AggregationTypes.Average | AggregationTypes.Sum | AggregationTypes.Max | AggregationTypes.MostRecent, AggregationTypes.Sum, AggregationTypes.Sum, MissingSampleHandling.LinearEstimation);
        _failures = ambientStatistics?.GetOrAddStatistic(false, typeName + "-Failures", "Failures", "The total number of failures", false, "", 0, null, null, 0, AggregationTypes.Average | AggregationTypes.Max | AggregationTypes.MostRecent, AggregationTypes.Average | AggregationTypes.Sum | AggregationTypes.Max | AggregationTypes.MostRecent, AggregationTypes.Sum, AggregationTypes.Sum, MissingSampleHandling.LinearEstimation);
        _timeouts = ambientStatistics?.GetOrAddStatistic(false, typeName + "-Timeouts", "Timeouts", "The total number of timeouts", false, "", 0, null, null, 0, AggregationTypes.Average | AggregationTypes.Max | AggregationTypes.MostRecent, AggregationTypes.Average | AggregationTypes.Sum | AggregationTypes.Max | AggregationTypes.MostRecent, AggregationTypes.Sum, AggregationTypes.Sum, MissingSampleHandling.LinearEstimation);
    }
    /// <summary>
