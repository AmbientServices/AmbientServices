...
[![CI](https://github.com/AmbientServices/AmbientServices/actions/workflows/Build.yml/badge.svg)](https://github.com/AmbientServices/AmbientServices/actions/workflows/Build.yml)
...
The CI badge reflects the full workflow on `master` (build, tests, and package). The line-coverage badge is generated by [ReportGenerator](https://github.com/danielpalme/ReportGenerator) and published to [GitHub Pages](https://docs.github.com/pages) with the HTML report ([`index.html`](https://ambientservices.github.io/AmbientServices/)). If the site is not updating, set **Settings → Pages → Build and deployment** to **GitHub Actions**.
